...
# LastEditTime : 2025-05-09 21:08:44
# FilePath     : \undefinedd:\Users\Linkcy97\Desktop\Tools\raw_rename\Raw_rename.py

import shutil
from pathlib import Path

def move_and_rename_files(folder_path, prefix):
    ...
    if len(jpg_files) != len(raw_files):
        print("JPG 和 RAW 文件数量不一致，无法正确匹配。")
        return
...
if __name__ == "__main__":
    ...
    move_and_rename_files(user_input, prefix)
    input("处理完成。按回车键退出...")
